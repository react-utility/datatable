...
const Header: React.FC<HeaderProps> = (props) => {
    ...
    const handleOnClick = (event : React.MouseEvent<HTMLButtonElement>) => {
        ...
        props.onColumnClick!(!headerClicked,props.item,event);
    }
    return (
        <th>
            <div className={props.classNames!.headerInner}>
                ...
                {
                    props.item.sortable && props.item.sortIcon && <props.item.sortIcon props={props} isHeaderClicked={headerClicked} onSortClicked={props.onSortClick!} prevDirection={props.item.sortDirection!} isHovered={isHovered} />
                }
                {
                    props.item.sortable && !props.item.sortIcon && <SortIcon props={props} isHeaderClicked={headerClicked} onSortClicked={props.onSortClick!} prevDirection={props.item.sortDirection!}/>
                }
