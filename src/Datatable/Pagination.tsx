...
const Pagination: React.FC<PaginationProps> = (props) => {
    ...
    const handleCustomRowPerPageChange = (currentSelectedIndex: number) => {
        ...
        let data = props.data;
        data = data.slice(0, selectedRowPerPage);
        currentSliceIndex.current = { start: 0, end: selectedRowPerPage };
        props.updateRowsPerPage(data, currentSelectedIndex);
    }
    ...
    return (
        <div className={props.classNames.pagination}>
            {
                props.tableOptions.customRowPerPageDropdown && props.tableOptions.showRowPerPageDropdown &&
                <props.tableOptions.customRowPerPageDropdown className={props.classNames.paginationDropdown} updateRows={handleCustomRowPerPageChange} rowsPerPage={props.tableOptions.rowsPerPage} />
            }
            {
                !props.tableOptions.customRowPerPageDropdown && props.tableOptions.showRowPerPageDropdown &&
