...
const CustomIcon = ({isHeaderClicked, onSortClicked, prevDirection, isHeaderHovered}) => {
    let direction;
    ...
    return (
        <div className="header-icon">
            {
                !isHeaderClicked && isHeaderHovered && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" >
            ...
            {
                isHeaderClicked && asc && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" onClick={(e) => {
                    onSortClicked(!asc, e);
                    setAsc(!asc);
                }}>
                    <path fillRule="evenodd" d="M11.36 7.098c-1.137 0-1.708-.657-1.762-1.278h1.004c.058.223.343.45.773.45.824 0 1.164-.829 1.133-1.856h-.059c-.148.39-.57.742-1.261.742-.91 0-1.72-.613-1.72-1.758 0-1.148.848-1.836 1.973-1.836 1.09 0 2.063.637 2.063 2.688 0 1.867-.723 2.848-2.145 2.848zm.062-2.735c.504 0 .933-.336.933-.972 0-.633-.398-1.008-.94-1.008-.52 0-.927.375-.927 1 0 .64.418.98.934.98z" />
        ...
        <div>
            <div>
                ...
                <div className="header-config">
                    ...
                    <pre>
                        Custom Component Props: {JSON.stringify({ "isHeaderClicked": "boolean", "onSortClicked": "function(sortDirection:Sorting,headerItem:TableColumn,event:React.MouseEvent)  => void", "prevDirection": "Sorting", "isHeaderHovered?": "boolean", "props": "HeaderProps" })}
                    </pre>
                </div>
